// <copyright file="OperationModule.cs" company="Fraunhofer Institute for Manufacturing Engineering and Automation IPA">
...
namespace Manager.Model.InstructionalModel.OperationModules
{
    using System;
